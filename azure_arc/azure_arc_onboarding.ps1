...
$resourceName = "name on pc" # will be "<name>  in azure arc" 
...
try {
    ...
    $env:SUBSCRIPTION_ID = "a359d4aa-201e-43e6-bce2-654bb5387e6a";
    $env:RESOURCE_GROUP = "ob05-rg-infraitsec-arc";
    $env:TENANT_ID = "42b38ed3-4451-4a95-a62f-b2250c2683ac";
    $env:LOCATION = "norwayeast";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "4167e148-9462-4537-bf73-f7c995ca3672";
    ...
    & "$env:ProgramW6432\AzureConnectedMachineAgent\azcmagent.exe" connect --resource-group "$env:RESOURCE_GROUP" --tenant-id "$env:TENANT_ID" --location "$env:LOCATION" --resource-name $resourceName --subscription-id "$env:SUBSCRIPTION_ID" --cloud "$env:CLOUD" --tags 'Datacenter=NTNU,City=Gjøvik,CountryOrRegion=Norway,Owner=oscarba@stud.ntnu.no,Project=infrait-lab,CostCenter=lab,Comments=Teste Azure Arc' --correlation-id "$env:CORRELATION_ID";
}
catch {
